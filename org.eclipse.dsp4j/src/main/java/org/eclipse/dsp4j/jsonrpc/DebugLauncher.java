...
/**
 * This is the entry point for applications that use DSP4J. A DebugLauncher does all the wiring that is necessary to connect
 * your endpoint via an input stream and an output stream.
 */
public interface DebugLauncher<T> {
